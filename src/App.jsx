  ...
  const skillsData = {
    cybersecurity: {
      ...
      skills: [
        ...
        { name: 'Wireshark', icon: <img src="/icons/wireshark.svg" alt="Wireshark" /> },
        { name: 'Burp Suite', icon: <img src="/icons/burpsuite.svg" alt="Wireshark" /> },
        { name: 'Metasploit', icon: <img src="/icons/metasploit.svg" alt="Wireshark" /> },
      ]
    },
    backend: {
